...
export function AssistantPanel({ state }: { state: RunState }) {
  ...
  if (!open) {
    return (
      <button
        ...
        className="sticky top-0 flex h-screen w-12 shrink-0 flex-col items-center gap-3 border-l border-hairline/80 bg-canvas/80 py-6 text-mute backdrop-blur-md hover:text-primary"
  ...
  return (
    <div className="sticky top-0 flex h-screen w-[380px] shrink-0 flex-col border-l border-hairline/80 bg-canvas/95 backdrop-blur-md">
      <div className="flex items-center gap-2 border-b border-hairline px-4 py-4">
        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-accent-purple/30 to-accent-purple/10 text-accent-purple">

...
type Tone = "neutral" | "good" | "warning" | "critical" | "primary" | "info";
...
export function Badge({
  ...
  return (
    <span
      className={clsx(
        "inline-flex items-center gap-1.5 rounded-sm border px-2 py-0.5 text-[11px] font-bold uppercase tracking-wide",
        TONE_CLASSES[tone],
        className,
      )}
    >

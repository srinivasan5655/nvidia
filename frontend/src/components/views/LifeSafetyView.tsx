  ...
  if (state.overallStatus === "blocked") {
    return (
      <EmptyState
        ...
        body="Check the Runtime & Gates view for which gate blocked and why — no guidance is produced downstream of a block."
      />
    );
  }
    ...
    <div className="flex flex-col gap-4">
      ...
      <Card corner>
        ...
        <div className="max-w-xs">
          <ConfidenceBar value={ls.confidence} label="Guidance confidence" />
        </div>
      </Card>
